...
const SolutionSection = () => {
  return (
    <section className="py-16 md:py-32 px-4 sm:px-6 bg-[#122E54]/70 backdrop-blur-xl text-white rounded-[2rem] md:rounded-[3rem] shadow-2xl relative overflow-hidden -mt-4 md:-mt-8 z-10 w-full max-w-[100vw]">
